...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path				= 'third_party/modules/grocery_crud/languages';
	protected $default_config_path					= 'third_party/modules/grocery_crud/config';
	protected $default_assets_path					= 'third_party/modules/grocery_crud';
