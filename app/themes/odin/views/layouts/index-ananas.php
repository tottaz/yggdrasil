	...
	<header id="header">		
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
				...
				<?php if (is_sadmin() or isset($this->permissions['media'])): ?>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('global:addarticle'); ?> <b class="caret"></b></a>
					<ul class="dropdown-menu">
				...
				<?php if (is_sadmin() or isset($this->permissions['media'])): ?>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('global:stats'); ?> <b class="caret"></b></a>
					<ul class="dropdown-menu">
				...
				<?php if (is_sadmin() or isset($this->permissions['media'])): ?>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('global:insights'); ?> <b class="caret"></b></a>
					<ul class="dropdown-menu">					
