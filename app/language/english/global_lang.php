...
$lang = array(
	...
	/** Emily Global **/
	'global:emily' => 'Emily',
	'emily:dashboard' => 'Dashboard',
	'emily:whois'=> 'Who is onboard',
	'emily:crew'=> 'Crew',
	'emily:history'=> 'History',
	'emily:allhistory'=> 'All History',
	'emily:cashbookformat'=> 'Cashbook format',
	'emily:removescheduledpeople'=> 'Remove scheduled people',
	'emily:lists'=> 'Lists',
	'emily:currentcrewlists'=> 'Current crew list',
	'emily:currentcrewchanges'=> 'Crew Changes',
	'emily:musterlist'=> 'Muster List',
	'emily:schedule'=> 'Schedule',
	'emily:portsofcall'=> 'Ports of call',
	'emily:agents'=> 'Agents',
	'emily:ports'=> 'Ports',
	'emily:noonreport'=> 'Noon Report',
	'emily:checkmgofw'=> 'Check MGO/FW',
	'emily:logextractviewer'=> 'Log Extract Viewer',
	'emily:download'=> 'Download',
	'emily:noonsync'=> 'Sync',
	'emily:adminconfig'=> 'Config',    
	'emily:admincountry'=> 'Country',
	'emily:adminmartialstatus'=> 'Martial Status',
	'emily:admindiet'=> 'Diet',
	'emily:adminrank'=> 'Rank',
	'emily:adminships'=> 'Ships',
	'emily:adminoffice'=> 'Office/department',
	'emily:ports'=> 'Ports',
	'emily:sync'=> 'Sync',    
	...
	'update:errordownloading' => 'An update to Emily is available, but Emily is having problems downloading it.',
	...
	'update:deleteemilysystemupdate' => 'Delete the Emily-update-system folder (inside the uploads folder), and all its contents.',
	'update:loademilyagain' => "Load Emily again. If the error persists, change the owner of the Emily folder (chown) so it matches the web server's user. If you can't do that, or don't know how to, please send an email to support@thunderebardesign.com, and we'll help you.",
	'update:whatschanged' => "What's new in :1",
	'update:ftp_conn' => 'Emily could not connect to the FTP host.',
	'update:ftp_login' => 'Emily could not login via FTP (wrong FTP username/password?).',
	'update:ftp_chdir' => 'Emily could not set the FTP path (path probably does not exist).',
	'update:ftp_no_uploads' => 'Emily could not obtain permission to upload files via FTP.',
	'update:ftp_indexwrong' => 'The FTP Path you entered is incorrect. It should be the path to Emily\'s directory.',
	'update:ftp_indexnotfound' => 'The FTP Path you entered is incorrect. It should be the path to Emily\'s directory.',
	...
	'update:update_no_perms' => 'Emily does not have enough permissions to update itself, nor does it have access to an FTP account from which it can update itself. Update cannot continue.',
	'update:review_files' => 'Please review these files and make backups of them before proceeding. When the upgrade is finished, you will have to re-integrate your modifications back into them. Please do not just replace the updated files with your outdated modified copies, as that may break Emily.',
	'update:internetissues' => "Emily is unable to connect to the Internet.",
	'update:emilyneedsinternet' => 'For Emily to function correctly, your server must allow it to fetch some information from the Internet (port 80).',
	'update:maybefirewall' => "It appears that your server is blocking Emily from accessing the Internet. This could be a firewall issue in your server. Please contact your host for help. Ask them to allow PHP to access :1.",
	'update:nointernetaccess' => 'No Internet Access',
	'update:emilyupdated' => 'Emily was upgraded from :1 to :2',
	/** Action Logger  **/
