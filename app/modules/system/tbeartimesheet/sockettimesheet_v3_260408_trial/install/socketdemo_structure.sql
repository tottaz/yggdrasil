...
CREATE TABLE client (
  ...
  `BillingRateDescription` char(50) default NULL,
...
CREATE TABLE config (
  ...
  `Default_Name` char(200) default NULL,
  `Version` char(10) default NULL,
  `Support` char(200) default NULL,
  `URL_Contact` char(200) default NULL,
  `InstallDate` date default NULL,
  `Database_Name` char(100) default NULL,
  `Table_Prefix` char(100) default NULL,
  `ROOTDIR` char(200) default NULL,
...
CREATE TABLE email_admin (
  `ID` int(11) NOT NULL auto_increment,
  `admin_useradded_user` char(10) default NULL,
  `admin_useradded_admin` char(10) default NULL,
  `admin_useradded_supervisor` char(10) default NULL,
  `admin_userupdated_user` char(10) default NULL,
  `admin_userupdated_admin` char(10) default NULL,
  `admin_userupdated_supervisor` char(10) default NULL,
  `admin_userdeleted_user` char(10) default NULL,
  `admin_userdeleted_admin` char(10) default NULL,
  `admin_userdeleted_supervisor` char(10) default NULL,
  `admin_userdisabled_user` char(10) default NULL,
  `admin_userdisabled_admin` char(10) default NULL,
  `admin_userdisabled_supervisor` char(10) default NULL,
  `admin_userpassword_user` char(10) default NULL,
  `admin_userpassword_admin` char(10) default NULL,
  `admin_userpassword_supervisor` char(10) default NULL,
  `project_added_team` char(10) default NULL,
  `project_added_pm` char(10) default NULL,
  `project_updated_team` char(10) default NULL,
  `project_updated_pm` char(10) default NULL,
  `project_deleted_team` char(10) default NULL,
  `project_deleted_pm` char(10) default NULL,
  `project_started_team` char(10) default NULL,
  `project_started_pm` char(10) default NULL,
  `project_closed_team` char(10) default NULL,
  `project_closed_pm` char(10) default NULL,
  `timesheet_approval_user` char(10) default NULL,
  `timesheet_approval_spr` char(10) default NULL,
  `timesheet_approval_pm` char(10) default NULL,
  `timesheet_approved_user` char(10) default NULL,
  `timesheet_approved_spr` char(10) default NULL,
  `timesheet_approved_pm` char(10) default NULL,
  `timesheet_rejected_user` char(10) default NULL,
  `timesheet_rejected_spr` char(10) default NULL,
  `timesheet_rejected_pm` char(10) default NULL,
  `timesheet_undoreq_user` char(10) default NULL,
  `timesheet_undoreq_admin` char(10) default NULL,
  `timesheet_undocancel_user` char(10) default NULL,
  `timesheet_undocancel_admin` char(10) default NULL,
  `timesheet_undoapproved_user` char(10) default NULL,
  `timesheet_undoapproved_admin` char(10) default NULL,
  `timesheet_due_user` char(10) default NULL,
  `timesheet_due_spr` char(10) default NULL,
  `timesheet_overdue_user` char(10) default NULL,
  `timesheet_overdue_spr` char(10) default NULL,
  `expenses_approval_user` char(10) default NULL,
  `expenses_approval_pm` char(10) default NULL,
  `expenses_approval_spr` char(10) default NULL,
  `expenses_approved_user` char(10) default NULL,
  `expenses_approved_pm` char(10) default NULL,
  `expenses_approved_spr` char(10) default NULL,
  `expenses_rejected_user` char(10) default NULL,
  `expenses_rejected_pm` char(10) default NULL,
  `expenses_rejected_spr` char(10) default NULL,
  `expenses_undoreq_user` char(10) default NULL,
  `expenses_undoreq_admin` char(10) default NULL,
  `expenses_undocancel_user` char(10) default NULL,
  `expenses_undocancel_admin` char(10) default NULL,
  `expenses_undoapproved_user` char(10) default NULL,
  `expenses_undoapproved_admin` char(10) default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM;
...
CREATE TABLE email_settings (
  `ID` int(11) NOT NULL auto_increment,
  `DefaultMail` varchar(100) NOT NULL default 'local',
  `SenderName` varchar(250) default NULL,
  `MailServer` varchar(250) default NULL,
  `MailPort` int(11) NOT NULL default '25',
  `Authentication` tinyint(1) NOT NULL default '1',
  `MailLogin` varchar(250) default NULL,
  `MailPassword` varchar(250) default NULL,
  `MailFormat` varchar(4) NOT NULL default 'HTML',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM;
...
CREATE TABLE file_upload (
  `ID` int(11) NOT NULL auto_increment,
  `OriName` char(200) NOT NULL default '',
  `NewName` char(200) NOT NULL default '',
  `Ext` char(10) NOT NULL default '',
  `Date` datetime NOT NULL default '0000-00-00 00:00:00',
  `MimeType` char(200) NOT NULL default 'application/octet-stream',
  `Size` int(11) NOT NULL default '0',
  `FullPath` char(250) NOT NULL default '',
...
CREATE TABLE name_format (
  ...
  `NameFormat` char(100) default NULL,
...
CREATE TABLE period (
  ...
  `OffDays` varchar(50) NOT NULL default '0:6:',
...
CREATE TABLE permission (
  ...
  `Selection` char(30) default NULL,
...
CREATE TABLE project_config (
  ...
  `PrjPrefix` varchar(50) NOT NULL default 'PRJ',
  `PrjDigit` int(10) NOT NULL default '5',
  `PrjSuffix` varchar(50) default NULL,
  `TaskPrefix` varchar(50) NOT NULL default 'TASK',
  `TaskDigit` int(10) NOT NULL default '5',
  `TaskSuffix` varchar(50) default NULL,
  `TaskTreeField` varchar(45) NOT NULL default 'Name',
  `TaskTreeSort` varchar(45) NOT NULL default 'ASC',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM;
...
CREATE TABLE report_saved (
  `ID` int(11) NOT NULL auto_increment,
  `ReportName` varchar(250) NOT NULL default '',
  `ReportLink` varchar(250) NOT NULL default '',
...
CREATE TABLE syslog (
  ...
  `LogAction` varchar(100) NOT NULL default '',
...
CREATE TABLE ts_submit_current (
  ...
  `ActionComment` char(250) default NULL,
  PRIMARY KEY  (`ID`),
  KEY `UserID` (`UserID`),
...
CREATE TABLE user_approval_listing (
  `ID` int(11) NOT NULL auto_increment,
  `UserID` int(11) NOT NULL default '0',
  `fieldTask` varchar(100) default NULL,
  `sortTypeTask` varchar(100) default NULL,
  `fieldTimeoff` varchar(100) default NULL,
  `sortTypeTimeoff` varchar(100) default NULL,
  `fieldOverall` varchar(100) default NULL,
  `sortTypeOverall` varchar(100) default NULL,
  PRIMARY KEY  (`ID`),
  KEY `UserID` (`UserID`)
) ENGINE=MyISAM;
...
CREATE TABLE user_listing (
  `ID` int(11) NOT NULL auto_increment,
  `UserID` int(11) NOT NULL default '0',
  `Listing` varchar(200) NOT NULL default '',
...
CREATE TABLE user_preference (
  ...
  `DateFormat` varchar(30) default 'd-m-Y',
  `DayOff` varchar(30) default '0:6:',
  ...
  `TimesheetList` varchar(100) default 'open',
  `PrjList` varchar(100) default 'open',
  `OpenTask` tinyint(1) NOT NULL default '0',
  `TaskShow` tinyint(1) NOT NULL default '0',
  `ThousandSeparator` varchar(5) NOT NULL default ',',
  `DecimalSeparator` varchar(5) NOT NULL default '.',
...
CREATE TABLE user_prj_listing (
  `ID` int(11) NOT NULL auto_increment,
  `UserID` int(11) default NULL,
  `ListType` char(200) default 'list_project',
  `FieldList` char(250) default 'name:1;task:1;code:1;leader:1;start:1;end:1;status:1;',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM;
...
CREATE TABLE user_startup (
  `ID` int(11) unsigned NOT NULL auto_increment,
  `UserID` int(11) NOT NULL default '0',
  `StartupLink` varchar(100) NOT NULL default '',
  `LoginType` varchar(50) NOT NULL default '',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM;
