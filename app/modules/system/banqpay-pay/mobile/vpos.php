...
if($base->input['cmd'] == '') { 
		...
		$FundPage->disable_cache();
		$FundPage->set_bgcolor( "#FFFFFF");        
        ...
        //Select Card Number
        $theNU = new HAW_input("number", "", "Card Number",  "*N");
        $theNU->set_size(12);
        ...
        $theCVV = new HAW_input("cvv2", "", "CVV",  "*N");
        $theCVV->set_size(3);
        ...
        //Billing Address
        //Address Line 1
        $theAD1 = new HAW_input("addr1", "", "Adress 1",  "*N");
        $theAD1->set_size(16);
        $theAD1->set_maxlength(100);
        
        //Address Line 2
        $theAD2 = new HAW_input("addr2", "", "Adress 2",  "*N");
        $theAD2->set_size(16);
...
//
      ...
      $SuccessPage->set_redirection(10, "mobile.php?s=");
    ...
    //
        ...
        // in case that the device does not support redirection:
        // ... we define a link additionally
        $link2 = new HAW_link("Main Page", "mobile.php?s=Menu", "Start");
