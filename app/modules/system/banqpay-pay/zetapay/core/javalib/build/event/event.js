 ...
 * @constructor
 */
BANQPAY.util.CustomEvent = function(type, oScope) {
    /**
    ...
    if (BANQPAY.util.Event) { 
        BANQPAY.util.Event.regCE(this);
    }
};

BANQPAY.util.CustomEvent.prototype = {
    /**
    ...
    subscribe: function(fn, obj, bOverride) {
        this.subscribers.push( new BANQPAY.util.Subscriber(fn, obj, bOverride) );
    },
 ...
 * @constructor
 */
BANQPAY.util.Subscriber = function(fn, obj, bOverride) {
    /**
 ...
 */
BANQPAY.util.Subscriber.prototype.contains = function(fn, obj) {
 ...
 */
        ...
        return { // PREPROCESS
            ...
            addListener: function(el, sType, fn, oScope, bOverride) {
                ...
                var wrappedFn = function(e) {
                        return fn.call(scope, BANQPAY.util.Event.getEvent(e), 
                                oScope);
                    };
                ...
                if (this.useLegacyEvent(el, sType)) {
                    ...
                    if (legacyIndex == -1) {
                        ...
                        el["on" + sType] = 
                            function(e) {
                                BANQPAY.util.Event.fireLegacyEvent(
                                    BANQPAY.util.Event.getEvent(e), legacyIndex);
                            };
                    }
            ...
            /**
             * Shorthand for BANQPAY.util.Event.addListener
             * @type function
             */
            // on: this.addListener,
     ...
     * @private
     */
    BANQPAY.util.Event.on = BANQPAY.util.Event.addListener;

    if (document && document.body) {
        BANQPAY.util.Event._load();
    } else {
        BANQPAY.util.Event.on(window, "load", BANQPAY.util.Event._load, 
                BANQPAY.util.Event, true);
    }

    BANQPAY.util.Event.on(window, "unload", BANQPAY.util.Event._unload, 
                BANQPAY.util.Event, true);

    BANQPAY.util.Event._tryPreloadAttach();
