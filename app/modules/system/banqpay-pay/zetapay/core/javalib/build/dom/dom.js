   ...
   return {
      ...
      setXY: function(el, pos, noRetry) {
         var f = function(el) {
            ...
            var pageXY = BANQPAY.util.Dom.getXY(el);
            if (pageXY === false) { return false; } // has to be part of doc to have pageXY
            
            var delta = [
               parseInt( BANQPAY.util.Dom.getStyle(el, 'left'), 10 ),
               parseInt( BANQPAY.util.Dom.getStyle(el, 'top'), 10 )
            ];
            ...
            if (!noRetry && (newXY[0] != pos[0] || newXY[1] != pos[1]) ) {
               var retry = function() { BANQPAY.util.Dom.setXY(el, pos, true); };
      ...
      getRegion: function(el) {
         var f = function(el) {
            return new BANQPAY.util.Region.getRegion(el);
         };
 ...
 * @constructor
 */
BANQPAY.util.Region = function(t, r, b, l) {
 ...
 *                          else false
 */
BANQPAY.util.Region.prototype.contains = function(region) {
 ...
 */
BANQPAY.util.Region.prototype.getArea = function() {
 ...
 */
BANQPAY.util.Region.prototype.intersect = function(region) {
    ...
    if (b >= t && r >= l) {
        return new BANQPAY.util.Region(t, r, b, l);
    } else {
        return null;
    }
};
 ...
 */
BANQPAY.util.Region.prototype.union = function(region) {
 ...
 */
BANQPAY.util.Region.prototype.toString = function() {
    return ( "Region {" +
             "t: "    + this.top    + 
             ", r: "    + this.right  + 
             ", b: "    + this.bottom + 
 ...
 * @static
 */
BANQPAY.util.Region.getRegion = function(el) {
    var p = BANQPAY.util.Dom.getXY(el);
 ...
 * @extends Region
 */
BANQPAY.util.Point = function(x, y) {
    /**
...
BANQPAY.util.Point.prototype = new BANQPAY.util.Region();
