...
* @constructor
* @extends BANQPAY.widget.Overlay
* @base BANQPAY.widget.Overlay
...
*/
BANQPAY.widget.MenuModule = function(p_oElement, p_oUserConfig) {

	if (arguments.length > 0) {

		BANQPAY.widget.MenuModule.superclass.constructor.call(
            this, 
            p_oElement, 
            p_oUserConfig
        );
...
BANQPAY.widget.MenuModule.prototype = new BANQPAY.widget.Overlay();
BANQPAY.widget.MenuModule.prototype.constructor = BANQPAY.widget.MenuModule;
BANQPAY.widget.MenuModule.superclass = BANQPAY.widget.Overlay.prototype;
...
* @type String
*/
BANQPAY.widget.MenuModule.prototype.CSS_CLASS_NAME = "yuimenu";
...
* is BANQPAY.widget.MenuModuleItem.
* @final
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype.ITEM_TYPE = null;
...
* @type String
*/
BANQPAY.widget.MenuModule.prototype.GROUP_TITLE_TAG_NAME = "H6";
...
* @type {Array}
*/
BANQPAY.widget.MenuModule.prototype._aGroupTitleElements = null;
...
* @type {Array}
*/
BANQPAY.widget.MenuModule.prototype._aItemGroups = null;
...
* @type {Array}
*/
BANQPAY.widget.MenuModule.prototype._aListElements = null;


/**
* Reference to the Event utility singleton.
* @private
* @type {BANQPAY.util.Event}
*/
BANQPAY.widget.MenuModule.prototype._oEventUtil = BANQPAY.util.Event;


/**
* Reference to the Dom utility singleton.
* @private
* @type {BANQPAY.util.Dom}
*/
BANQPAY.widget.MenuModule.prototype._oDom = BANQPAY.util.Dom;
...
* @type {BANQPAY.widget.MenuModuleItem}
*/
BANQPAY.widget.MenuModule.prototype._oCurrentItem = null;
...
* @type {Boolean}
*/
BANQPAY.widget.MenuModule.prototype._bFiredMouseOverEvent = false;
...
* @type {Boolean}
*/
BANQPAY.widget.MenuModule.prototype._bFiredMouseOutEvent = false;
...
* @type {BANQPAY.widget.MenuModuleItem}
*/
BANQPAY.widget.MenuModule.prototype.activeItem = null;
...
* @type {BANQPAY.widget.MenuModuleItem}
*/
BANQPAY.widget.MenuModule.prototype.parent = null;
...
*/
BANQPAY.widget.MenuModule.prototype.srcElement = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.mouseOverEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.mouseOutEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.mouseDownEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.mouseUpEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.clickEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.keyPressEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.keyDownEvent = null;
...
* @see BANQPAY.util.CustomEvent
*/
BANQPAY.widget.MenuModule.prototype.keyUpEvent = null;
...
* configuration class documentation for more details.
*/
BANQPAY.widget.MenuModule.prototype.init = function(p_oElement, p_oUserConfig) {

    if(!this.ITEM_TYPE) {

        this.ITEM_TYPE = BANQPAY.widget.MenuModuleItem;
    ...
    if(oElement) {
        ...
        switch(oElement.tagName) {
            ...
            case "DIV":
                ...
                */ 
                ...
                BANQPAY.widget.MenuModule.superclass.init.call(this, oElement);

                this.beforeInitEvent.fire(BANQPAY.widget.MenuModule);
            ...
            case "SELECT":
                ...
                */ 
                ...
                BANQPAY.widget.MenuModule.superclass.init.call(this, sId); 
        ...
        */ 
        ...
        BANQPAY.widget.MenuModule.superclass.init.call(this, p_oElement);
    ...
    if(this.element) {
        ...
        var CustomEvent = BANQPAY.util.CustomEvent;
    ...
    this.initEvent.fire(BANQPAY.widget.MenuModule);
...
* @private
*/
BANQPAY.widget.MenuModule.prototype._getFirstEnabledItem = function() {
...
* @type Boolean
*/
BANQPAY.widget.MenuModule.prototype._checkPosition = function(p_sPosition) {
...
* the item belongs.
* @param {BANQPAY.widget.MenuModuleItem} p_oItem The item to be added.
* @param {Number} p_nItemIndex Optional. Index at which the item 
* should be added.
* @return The item that was added.
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype._addItemToGroup = 
...
* @type BANQPAY.widget.MenuModuleItem
*/    
BANQPAY.widget.MenuModule.prototype._removeItemFromGroupByIndex = 
...
* @param {Number} p_nGroupIndex Number indicating the group to which
* the item belongs.
* @param {BANQPAY.widget.MenuModuleItem} p_oItem The item to be removed.
* @return The item that was removed.
* @type BANQPAY.widget.MenuModuleItem
*/    
BANQPAY.widget.MenuModule.prototype._removeItemFromGroupByValue =
...
*/
BANQPAY.widget.MenuModule.prototype._updateItemProperties = 
...
* @type Array
*/
BANQPAY.widget.MenuModule.prototype._createItemGroup = function(p_nIndex) {
...
* @type Array
*/
BANQPAY.widget.MenuModule.prototype._getItemGroup = function(p_nIndex) {
...
* @private
* @param {BANQPAY.widget.MenuModuleItem} p_oItem The item to listen
* for events on.
*/
BANQPAY.widget.MenuModule.prototype._configureItemSubmenuModule = 
...
* @private
* @param {BANQPAY.widget.MenuModuleItem} p_oItem The item to listen for events on.
*/
BANQPAY.widget.MenuModule.prototype._subscribeToItemEvents = function(p_oItem) {
...
* @private
*/
BANQPAY.widget.MenuModule.prototype._getOffsetWidth = function() {
...
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype._fireItemEvent = 
...
* utility (BANQPAY.util.Event).
* @param {BANQPAY.widget.MenuModule} p_oMenuModule The MenuModule instance 
* corresponding to the HTMLDivElement that fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onDOMEvent = 
...
* corresponding to the HTMLDivElement that fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onElementMouseOver = 
...
* corresponding to the HTMLDivElement that fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onElementMouseOut = 
...
* event utility (BANQPAY.util.Event).
* @param {BANQPAY.widget.MenuModule} p_oMenuModule The MenuModule instance 
* corresponding to the HTMLDivElement that fired the event.
*/         
BANQPAY.widget.MenuModule.prototype._onElementClick = 
...
* @private
*/
BANQPAY.widget.MenuModule.prototype._initSubTree = function() {
...
* was fired.
* @param {BANQPAY.widget.MenuModule} p_oMenuModule The MenuModule instance that 
* fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onBeforeRender = 
...
* fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onRender = 
...
* fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onShow = 
...
* fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onHide = 
...
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
* @param {BANQPAY.widget.MenuModule} p_oSubmenu The submenu that subscribed
* to the event.
*/
BANQPAY.widget.MenuModule.prototype._onParentMenuModuleConfigChange = 
...
* to the event.
*/
BANQPAY.widget.MenuModule.prototype._onParentMenuModuleRender = 
...
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
* @param {BANQPAY.widget.MenuModule} p_oSubmenu The submenu that fired
* the event.
*/
BANQPAY.widget.MenuModule.prototype._onSubmenuBeforeShow = 
...
* the event.
*/
BANQPAY.widget.MenuModule.prototype._onSubmenuShow = 
...
* the event.
*/
BANQPAY.widget.MenuModule.prototype._onSubmenuHide = 
...
/**
* "focus" BANQPAY.util.CustomEvent handler for a MenuModule instance's items.
* @private
* @param {String} p_sType The name of the event that was fired.
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
...
*/
BANQPAY.widget.MenuModule.prototype._onItemFocus = 
...
/**
* "blur" BANQPAY.util.CustomEvent handler for a MenuModule instance's items.
* @private
* @param {String} p_sType The name of the event that was fired.
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
...
* and the item that fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onItemBlur = 
...
/**
* "configchange" BANQPAY.util.CustomEvent handler for the MenuModule 
* instance's items.
* @private
* @param {String} p_sType The name of the event that was fired.
...
* and the item that fired the event.
*/
BANQPAY.widget.MenuModule.prototype._onItemConfigChange = 
...
*/
BANQPAY.widget.MenuModule.prototype.enforceConstraints = 
    ...
    function(type, args, obj) {
        ...
        var pos = args[0],
            ...
            bodyOverflow = BANQPAY.util.Dom.getStyle(bod, "overflow"),
            htmOverflow = BANQPAY.util.Dom.getStyle(htm, "overflow"),
    
            offsetHeight = this.element.offsetHeight,
            offsetWidth = this.element.offsetWidth,
        
            viewPortWidth = BANQPAY.util.Dom.getClientWidth(),
            viewPortHeight = BANQPAY.util.Dom.getClientHeight(),
...
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
* @param {BANQPAY.widget.MenuModule} p_oMenuModule The MenuModule instance fired
* the event.
* @see BANQPAY.widget.Overlay#configIframe
*/
BANQPAY.widget.MenuModule.prototype.configPosition = 
...
* the title belongs.
*/
BANQPAY.widget.MenuModule.prototype.setItemGroupTitle = 
...
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype.addItem = function(p_oItem, p_nGroupIndex) {

    if(p_oItem && p_oItem instanceof BANQPAY.widget.MenuModuleItem) {
...
* @param {BANQPAY.widget.MenuModuleItem} p_oItem The item to be inserted.
...
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype.insertItem = 
...
* @param {BANQPAY.widget.MenuModuleItem/Number} p_oObject The item or index of the
* item to be removed.
* @param {Number} p_nGroupIndex Optional. Number indicating the group to which
* the item belongs.
...
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype.removeItem =
    ...
    function(p_oObject, p_nGroupIndex) {
        ...
        if(typeof p_oObject != "undefined") {
            ...
            if(p_oObject instanceof BANQPAY.widget.MenuModuleItem) {
...
* @type Array
*/        
BANQPAY.widget.MenuModule.prototype.getItemGroups = function() {
...
* @type BANQPAY.widget.MenuModuleItem
*/
BANQPAY.widget.MenuModule.prototype.getItem = 
...
* elements to null.
*/
BANQPAY.widget.MenuModule.prototype.destroy = function() {
    ...
    BANQPAY.widget.MenuModule.superclass.destroy.call(this);
...
*/
BANQPAY.widget.MenuModule.prototype.setInitialFocus = function() {
...
*/
BANQPAY.widget.MenuModule.prototype.setInitialSelection = function() {
...
*/
BANQPAY.widget.MenuModule.prototype.clearActiveItem = function () {
...
*/
BANQPAY.widget.MenuModule.prototype.initDefaultConfig = function() {

    BANQPAY.widget.MenuModule.superclass.initDefaultConfig.call(this);
...
*/
BANQPAY.widget.MenuModuleItem = function(p_oObject, p_oUserConfig) {
...
BANQPAY.widget.MenuModuleItem.prototype = {
    ...
    * is BANQPAY.widget.MenuModule.
    * @final
    * @type BANQPAY.widget.MenuModule
    */
    SUBMENU_TYPE: null,
    ...
    * submenu's DOM.  
    * The default is BANQPAY.widget.MenuModuleItem.
    * @final
    * @type BANQPAY.widget.MenuModuleItem
    */
	...
	* @type BANQPAY.widget.MenuModuleItem
	*/
	constructor: BANQPAY.widget.MenuModuleItem,
    ...
    */
    init: function(p_oObject, p_oUserConfig) {
        ...
        if(!this.SUBMENU_TYPE) {
            ...
            this.SUBMENU_TYPE = BANQPAY.widget.MenuModule;
    
        }

        if(!this.SUBMENU_ITEM_TYPE) {
    
            this.SUBMENU_ITEM_TYPE = BANQPAY.widget.MenuModuleItem;
    ...
    * @param {Array} p_aArguments Collection of arguments sent when the 
    * event was fired.
    * @param {BANQPAY.widget.MenuModuleItem} p_oItem The MenuModuleItem instance 
    ...
    */
    getNextEnabledSibling: function() {
        ...
        if(this.parent instanceof BANQPAY.widget.MenuModule) {
...
/**
* @class Extends BANQPAY.widget.MenuModule to provide a set of default mouse and 
* key event behaviors.
* @constructor
* @extends BANQPAY.widget.MenuModule
* @base BANQPAY.widget.MenuModule
* @param {String or HTMLElement} p_oElement String id or HTMLElement 
* (either HTMLSelectElement or HTMLDivElement) of the source HTMLElement node.
* @param {Object} p_oUserConfig Optional. The configuration object literal 
...
* configuration class documentation for more details.
*/
BANQPAY.widget.Menu = function(p_oElement, p_oUserConfig) {

    if(arguments.length > 0) {

        BANQPAY.widget.Menu.superclass.constructor.call(
                this, 
                p_oElement,
                p_oUserConfig
            );
...
BANQPAY.widget.Menu.prototype = new BANQPAY.widget.MenuModule();
BANQPAY.widget.Menu.prototype.constructor = BANQPAY.widget.Menu;
BANQPAY.widget.Menu.superclass = BANQPAY.widget.MenuModule.prototype;
...
* configuration class documentation for more details.
*/
BANQPAY.widget.Menu.prototype.init = function(p_oElement, p_oUserConfig) {

    if(!this.ITEM_TYPE) {

        this.ITEM_TYPE = BANQPAY.widget.MenuItem;

    }


    // Call the init of the superclass (BANQPAY.widget.Menu)

    BANQPAY.widget.Menu.superclass.init.call(this, p_oElement);


    this.beforeInitEvent.fire(BANQPAY.widget.Menu);
    ...
    this.initEvent.fire(BANQPAY.widget.Menu);
...
* @param {Array} p_aArguments Collection of arguments sent when the event 
* was fired.
* @param {BANQPAY.widget.Menu} p_oMenu The Menu instance that fired the event.
*/
BANQPAY.widget.Menu.prototype._onMouseOver = 
...
* @param {BANQPAY.widget.Menu} p_oMenu The Menu instance that fired the event.
*/
BANQPAY.widget.Menu.prototype._onKeyDown = 
        ...
        if(this.cfg.getProperty("position") == "dynamic") {
            ...
            if(oEvent.keyCode == 27) { // Esc key
                ...
                if(this.parent) {
                    ...
                    if(this.parent.parent instanceof BANQPAY.widget.Menu) {
...
* Menu instance.  MenuItem extends BANQPAY.widget.MenuModuleItem to provide a 
* set of default mouse and key event behaviors.
* @constructor
* @extends BANQPAY.widget.MenuModuleItem
* @base BANQPAY.widget.MenuModuleItem
* @param {String or HTMLElement} p_oObject String or HTMLElement 
* (either HTMLLIElement, HTMLOptGroupElement or HTMLOptionElement) of the 
* source HTMLElement node.
* @param {Object} p_oUserConfig The configuration object literal containing 
...
* class documentation for more details.
*/
BANQPAY.widget.MenuItem = function(p_oObject, p_oUserConfig) {

    if(p_oObject) {

        BANQPAY.widget.MenuItem.superclass.constructor.call(
            this, 
            p_oObject, 
            p_oUserConfig
        );
...
BANQPAY.widget.MenuItem.prototype = new BANQPAY.widget.MenuModuleItem();
BANQPAY.widget.MenuItem.prototype.constructor = BANQPAY.widget.MenuItem;
BANQPAY.widget.MenuItem.superclass = BANQPAY.widget.MenuModuleItem.prototype;
...
* class documentation for more details.
*/
BANQPAY.widget.MenuItem.prototype.init = function(p_oObject, p_oUserConfig) {

    if(!this.SUBMENU_TYPE) {

        this.SUBMENU_TYPE = BANQPAY.widget.Menu;

    }

    if(!this.SUBMENU_ITEM_TYPE) {

        this.SUBMENU_ITEM_TYPE = BANQPAY.widget.MenuItem;

    }


    /* 
        Call the init of the superclass (BANQPAY.widget.MenuModuleItem)
        Note: We don't pass the user config in here yet 
        because we only want it executed once, at the lowest 
        subclass level.
    */ 

    BANQPAY.widget.MenuItem.superclass.init.call(this, p_oObject);  
...
* fired the event.
*/
BANQPAY.widget.MenuItem.prototype._onKeyDown = 
    ...
    function(p_sType, p_aArguments, p_oMenuItem) {
        ...
        switch(oEvent.keyCode) {
            ...
            case 40:    // Down arrow
                ...
                BANQPAY.util.Event.preventDefault(oEvent);
            ...
            case 39:    // Right arrow
                ...
                if(oSubmenu) {
                    ...
                    BANQPAY.widget.MenuBarItem && 
                    this.parent.parent && 
                    this.parent.parent instanceof BANQPAY.widget.MenuBarItem
                ) {
...
* fired the event.
*/
BANQPAY.widget.MenuItem.prototype._onMouseOver = 
...
* fired the event.
*/
BANQPAY.widget.MenuItem.prototype._onMouseOut = 
...
* @constructor
* @extends BANQPAY.widget.Menu
* @base BANQPAY.widget.Menu
* @param {String or HTMLElement} p_oElement String id or HTMLElement 
* (either HTMLSelectElement or HTMLDivElement) of the source HTMLElement node.
* @param {Object} p_oUserConfig Optional. The configuration object literal 
...
* configuration class documentation for more details.
*/
BANQPAY.widget.ContextMenu = function(p_oElement, p_oUserConfig) {

    if(arguments.length > 0) {

        BANQPAY.widget.ContextMenu.superclass.constructor.call(
                this, 
                p_oElement,
                p_oUserConfig
            );
...
BANQPAY.widget.ContextMenu.prototype = new BANQPAY.widget.Menu();
BANQPAY.widget.ContextMenu.prototype.constructor = BANQPAY.widget.ContextMenu;
BANQPAY.widget.ContextMenu.superclass = BANQPAY.widget.Menu.prototype;
...
* configuration class documentation for more details.
*/
BANQPAY.widget.ContextMenu.prototype.init = function(p_oElement, p_oUserConfig) {

    if(!this.ITEM_TYPE) {

        this.ITEM_TYPE = BANQPAY.widget.ContextMenuItem;
    ...
    BANQPAY.widget.ContextMenu.superclass.init.call(this, p_oElement);


    this.beforeInitEvent.fire(BANQPAY.widget.ContextMenu);
    ...
    this.initEvent.fire(BANQPAY.widget.ContextMenu);
...
* @param {Event} p_oEvent Event object passed back by the 
* event utility (BANQPAY.util.Event).
* @param {BANQPAY.widget.ContextMenu} p_oMenu The ContextMenu instance 
* handling the event.
*/
BANQPAY.widget.ContextMenu.prototype._onDocumentMouseDown = 
...
* handling the event.
*/
BANQPAY.widget.ContextMenu.prototype._onTriggerClick = 
...
* handling the event.
*/
BANQPAY.widget.ContextMenu.prototype._onTriggerContextMenu = 
...
* @type HTMLElement
*/
BANQPAY.widget.ContextMenu.prototype.contextEventTarget = null;
...
*/
BANQPAY.widget.ContextMenu.prototype.initDefaultConfig = function() {

    BANQPAY.widget.ContextMenu.superclass.initDefaultConfig.call(this);
...
* @param {Array} p_aArguments Collection of arguments sent when the 
* event was fired.
* @param {BANQPAY.widget.ContextMenu} p_oMenu The ContextMenu that instance fired
* the event.
*/
BANQPAY.widget.ContextMenu.prototype.configTrigger = 
...
* @constructor
* @extends BANQPAY.widget.MenuItem
* @base BANQPAY.widget.MenuItem
* @param {String or HTMLElement} p_oObject String or HTMLElement 
* (either HTMLLIElement, HTMLOptGroupElement or HTMLOptionElement) of the 
* source HTMLElement node.
* @param {Object} p_oUserConfig The configuration object literal containing 
...
* class documentation for more details.
*/
BANQPAY.widget.ContextMenuItem = function(p_oObject, p_oUserConfig) {

    if(p_oObject) {

        BANQPAY.widget.ContextMenuItem.superclass.constructor.call(
            this, 
            p_oObject, 
            p_oUserConfig
        );
...
BANQPAY.widget.ContextMenuItem.prototype = new BANQPAY.widget.MenuItem();

BANQPAY.widget.ContextMenuItem.prototype.constructor = 

    BANQPAY.widget.ContextMenuItem;

BANQPAY.widget.ContextMenuItem.superclass = BANQPAY.widget.MenuItem.prototype;
...
* class documentation for more details.
*/
BANQPAY.widget.ContextMenuItem.prototype.init = 

    function(p_oObject, p_oUserConfig) {
    
        if(!this.SUBMENU_TYPE) {
    
            this.SUBMENU_TYPE = BANQPAY.widget.ContextMenu;
    
        }
    
        if(!this.SUBMENU_ITEM_TYPE) {
    
            this.SUBMENU_ITEM_TYPE = BANQPAY.widget.ContextMenuItem;
    
        }
    
    
        /* 
            Call the init of the superclass (BANQPAY.widget.MenuItem)
            Note: We don't pass the user config in here yet 
            because we only want it executed once, at the lowest 
            subclass level.
        */ 
    
        BANQPAY.widget.ContextMenuItem.superclass.init.call(this, p_oObject);
...
* Extends BANQPAY.widget.MenuModule to provide a set of default mouse and 
* key event behaviors.
* @constructor
* @extends BANQPAY.widget.MenuModule
* @base BANQPAY.widget.MenuModule
...
* configuration class documentation for more details.
*/
BANQPAY.widget.MenuBar = function(p_oElement, p_oUserConfig) {

    if(arguments.length > 0) {

        BANQPAY.widget.MenuBar.superclass.constructor.call(
                this, 
                p_oElement,
                p_oUserConfig
            );
...
BANQPAY.widget.MenuBar.prototype = new BANQPAY.widget.MenuModule();
BANQPAY.widget.MenuBar.prototype.constructor = BANQPAY.widget.MenuBar;
BANQPAY.widget.MenuBar.superclass = BANQPAY.widget.MenuModule.prototype;
...
* configuration class documentation for more details.
*/
BANQPAY.widget.MenuBar.prototype.init = function(p_oElement, p_oUserConfig) {

    if(!this.ITEM_TYPE) {

        this.ITEM_TYPE = BANQPAY.widget.MenuBarItem;

    }


    // Call the init of the superclass (BANQPAY.widget.MenuModule)

    BANQPAY.widget.MenuBar.superclass.init.call(this, p_oElement);


    this.beforeInitEvent.fire(BANQPAY.widget.MenuBar);
    ...
    */
    ...
    this.initEvent.fire(BANQPAY.widget.MenuBar);
...
* @type String
*/
BANQPAY.widget.MenuBar.prototype.CSS_CLASS_NAME = "yuimenubar"; 


/**
* @class The MenuBarItem class allows you to create and modify an item for a
* MenuBar instance.  MenuBarItem extends BANQPAY.widget.MenuModuleItem to provide 
...
* class documentation for more details.
*/
BANQPAY.widget.MenuBarItem = function(p_oObject, p_oUserConfig) {

    if(p_oObject) {

        BANQPAY.widget.MenuBarItem.superclass.constructor.call(
            this, 
            p_oObject, 
            p_oUserConfig
        );
...
BANQPAY.widget.MenuBarItem.prototype = new BANQPAY.widget.MenuModuleItem();
BANQPAY.widget.MenuBarItem.prototype.constructor = BANQPAY.widget.MenuBarItem;
BANQPAY.widget.MenuBarItem.superclass = BANQPAY.widget.MenuModuleItem.prototype;
...
* class documentation for more details.
*/
BANQPAY.widget.MenuBarItem.prototype.init = function(p_oObject, p_oUserConfig) {
    ...
    */ 
    ...
    BANQPAY.widget.MenuBarItem.superclass.init.call(this, p_oObject);  
...
* @type String
*/
BANQPAY.widget.MenuBarItem.prototype.CSS_CLASS_NAME = "yuimenubaritem";
...
* @type String
*/
BANQPAY.widget.MenuBarItem.prototype.SUBMENU_INDICATOR_IMAGE_PATH =
...
* @type String
*/
BANQPAY.widget.MenuBarItem.prototype.SELECTED_SUBMENU_INDICATOR_IMAGE_PATH =
...
* @type String
*/
BANQPAY.widget.MenuBarItem.prototype.DISABLED_SUBMENU_INDICATOR_IMAGE_PATH = 
...
* fired the event.
*/
BANQPAY.widget.MenuBarItem.prototype._onKeyDown =
