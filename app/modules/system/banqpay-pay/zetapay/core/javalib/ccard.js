...
function ccard_type(j) {
	if (ccard_f0.type.selectedIndex == 2) {
		ccard_cvv2_img.src = 'zetapay/images/buyer/cvv2amex.png';
	} else {
		ccard_cvv2_img.src = 'zetapay/images/buyer/cvv2vmc.png';
	}
}
...
function ccard_init() {
	...
	ccard_styleObj[0] = getStyleObject('ccard_typeC');
	ccard_styleObj[1] = getStyleObject('ccard_numberC');
	ccard_styleObj[2] = getStyleObject('ccard_expdateC');
	ccard_styleObj[3] = getStyleObject('ccard_expdateC');
	ccard_styleObj[4] = getStyleObject('ccard_nameC');
	ccard_styleObj[5] = getStyleObject('ccard_CVV2C');
	ccard_styleObj[6] = getStyleObject('ccard_addr1C');
	ccard_styleObj[7] = getStyleObject('ccard_addr2C');
	ccard_styleObj[8] = getStyleObject('ccard_cityC');
	ccard_styleObj[9] = getStyleObject('ccard_stateC');
	ccard_styleObj[10] = getStyleObject('ccard_zipC');
	ccard_styleObj[11] = getStyleObject('ccard_phoneC');
	ccard_styleObj[12] = getStyleObject('ccard_countryC');
