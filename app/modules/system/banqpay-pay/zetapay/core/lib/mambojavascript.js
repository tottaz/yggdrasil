...
//devin is changing this to our way.  You send in the name of the field
// the callback and then an optional form name...it defaults to thisform
function showCalendar(name,formN,cb) {
	var el = "";
	var myForm = "";
	//alert(document.forms['thisform']);
	//if a formname is not sent in then we default to thisform
	if(!formN){myForm =document.forms['thisform'];}
	else{myForm = document.forms[formN];}
//alert(myForm);
	//setting el to the element object
	el = myForm.elements[name];
