...
var _ugifpath="/zetapay/images/zeta.gif";	// set the web path to the zeta.gif file
...
var _uccn="sourceid";		// campaign name
var _ucmd="medium";		// medium (cpc|cpm|link|email|organic)
var _ucsr="subid";		// source
var _uctr="term";			// term/keyword
var _ucct="content";		// content
var _ucid="u_id";			// id number
var _ucno="nooverride";		// don't override
...
//-- Auto/Organic Keywords to override
var _uOno=new Array();
//_uOno[0]="google.com/adsense";
//_uOno[1]="www.google.com/adsense";
//_uOno[2]="adsense";
...
var _uff,_udh,_udt,_udo="",_uu,_ufns=0,_uns=0,_ur="-",_ufno=0,_ust=0,_ujv="-",_ubd=document,_udl=_ubd.location,_utcp="/adsense/",_uwv="6.2";
var _ugifpath2="/adsense/images/__utm.gif";
if (_udl.protocol=="https:") _ugifpath2="/adsense/images/__utm.gif";
if (!_utcp || _utcp=="") _utcp="/";
function _uTracker(page) {
 ...
 if(f==1) {
  _ubd.cookie="__utma="+a+"; path="+_utcp+";"+nx;
  _ubd.cookie="__utmb="+b+"; path="+_utcp+";"+x;
  _ubd.cookie="__utmc="+c+"; path="+_utcp+";";
 } else if (f==2) {
  a=_uFixA(s,"&",_ust);
  _ubd.cookie="__utma="+a+"; path="+_utcp+";"+nx;
  _ubd.cookie="__utmb="+_udh+"; path="+_utcp+";"+x;
  _ubd.cookie="__utmc="+_udh+"; path="+_utcp+";";
  _ufns=1;
 } else if (a>=0 && b>=0 && c>=0) {
 ...
 if (s && s!="" && s.indexOf("__utmv=")>=0) {
  if ((v=_uGC(s,"__utmv=","&"))!="-") {
   _ubd.cookie="__utmv="+unescape(v)+"; path="+_utcp+";"+nx+_udo;
  }
 }
 _uInfo(page);
 _ufns=0;
...
function _uCInfo() {
 ...
 var dc=_ubd.cookie;
 x=" expires="+x.toGMTString()+";";
 if (z!="-") { _ubd.cookie="__utmz="+unescape(z)+"; path="+_utcp+";"+x+_udo; return ""; }
