...
function ccard_cvv2help() {     
	window.open('/common/cvv2.html', '', 'location=no,resizable=yes,width=400,height=650,status=yes,scrollbar=auto');
}

function ccard_type(j) {
	if (ccard_f0.type.selectedIndex == 2) {
		ccard_cvv2_img.src = '/img/cvv2-amex.jpg';
	} else {
		ccard_cvv2_img.src = '/img/cvv2-vmc.jpg';
	}
}
