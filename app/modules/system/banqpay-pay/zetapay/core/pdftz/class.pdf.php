...
function getFontHeight($size){
  if (!$this->numFonts){
    $this->selectFont('/hsphere/local/home/epnnadmi/epnn.com/includes/pdf/font/Helvetica');
  }
...
function addText($x,$y,$size,$text,$angle=0,$wordSpaceAdjust=0){
  if (!$this->numFonts){$this->selectFont('/hsphere/local/home/epnnadmi/epnn.com/includes/pdf/font/Helvetica');}
