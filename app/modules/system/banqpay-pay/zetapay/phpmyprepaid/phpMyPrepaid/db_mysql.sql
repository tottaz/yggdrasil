...
#  Additions by Carl Peterson for phpMyPrepaid				  #
###########################################################################
#
...
CREATE TABLE radcheck (
  ...
  CrDate timestamp(14) NULL default 'NULL',
  creator varchar(20) NULL default 'NULL',
  Location smallint(4) NULL default 'NULL',
  activated smallint(4) NOT NULL default '0',
  activeDate timestamp(14) NULL default '',
