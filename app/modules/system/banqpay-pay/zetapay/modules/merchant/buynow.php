...
<tr>
	<td bgcolor="#FFFFFF">
		...
		<tr>
			...
			<tr>
				<td>
					<span class="text4">Buy Now Buttons</span><br>
...
<?	if($_POST['mybutton']){	?>
	<input type=image name="cartImage" src="<?=$siteurl?>/zetapay/images/buttons/<?=$_POST['mybutton']?>">
<?	}else{	?>
...
<?
	//$mybutton
	if( file_exists("images/buttons")){
		$handle=opendir("images/buttons");
...
?>
					<tr>
						...
						<td>
							<images src="zetapay/images/buttons/<?=$file?>">
						</td>
					</tr>
<?
				}
