	...
	<td bgcolor="#FFFFFF">
		...
		<tr>
    		<td valign="top">
        		...
        		<tr>
					<td>
						<span class="text4">Subscriptions and Recurring Payments</span><br>
...
?>
						...
						<tr>
							...
							<td width="80%"><input name="receiver" type="name" id="receiver" value="<?=$data->EMAIL?>"></td>
						</tr>
						<tr>
...
?>
						<tr>
							<th colspan=2><input name="create" type="submit" id="create" value="Create Button"></th>
						</tr>
						</table>
						</form>
<?
