...
?>        
								<TR>
									...
									<TD class=row<?=$i?> style="<?=$style?>" align=center><?=dp($a->PAIDTO == $user ? $a->PAIDBY : $a->PAIDTO)?>
									...
									<TD class=row<?=$i?> style="<?=$style?>" align=center><a href="index.php?a=merchant_transdet&did=<?=$a->ID?>">Details</a>
								</TR>
<?
						$i = 3 - $i;
					}
