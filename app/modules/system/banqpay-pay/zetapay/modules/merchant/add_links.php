...
if($_GET['process'] == 'delete') {
    $zetadb->Execute("DELETE FROM zetapay_merchant_link WHERE url_id='$_GET[url_id]'");
}

if($_POST['process'] == 'update') {

						$sql  = "UPDATE zetapay_merchant_link SET ";
...
<?
        ...
        $rs = $zetadb->Execute("SELECT * FROM zetapay_merchant_link WHERE url_id='$_GET[url_id]'");
...
?>`
						<td>
                                <input type=radio name=active value=1 <? echo $act1?>>&nbsp;Yes&nbsp&nbsp;
                                <input type=radio name=active value=2 <? echo $act2?>>&nbsp;No&nbsp&nbsp;
                        </td>
...
?>
						...
						<tr>
                            <td>
                                <input type="hidden" name="merchant_id" value="<?=$merchant_data->MERCHANT_ID?>">
...
<?
            $rs = $zetadb->Execute("SELECT * FROM zetapay_merchant_link WHERE merchant_id='$merchant_data->MERCHANT_ID'");
...
<?
                        ...
                        $premium_link .= '$';
		                $zetadb->Execute("UPDATE zetapay_merchant_link SET premium_link=$premium_link WHERE url_id=$link_id");
...
?>
						...
						<tr>
							<td height="24" align="center"><font size="2" face="Arial, Helvetica, sans-serif">Active</font></td>
							<td>
                                <input type=radio name=active value=1>&nbsp;Yes&nbsp&nbsp;
                                <input type=radio name=active value=2>&nbsp;No&nbsp&nbsp;
                            </td>
						...
						<tr>
                            <td>
                                <input type="hidden" name="merchant_id" value="<?=$merchant_data->MERCHANT_ID?>">
							    <input type="hidden" name="receiver" value="<?=$merchant_data->EMAIL?>">
