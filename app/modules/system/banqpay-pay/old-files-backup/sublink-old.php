...
?>
            <script>
                ...
                self.opener.document.forms['www.epnn.com'].useragent="BanQpay-PM";
                self.opener.document.forms['www.epnn.com'].remoteaddr="217.160.240.146";
                self.opener.document.forms['www.epnn.com'].action="<? echo $merchant_link ?>";
                self.opener.document.forms['www.epnn.com'].submit();
                //self.opener.location.href="<? echo $merchant_link ?>";
                self.close();
...
<?                        
            ...
            $data_stream .= "HTTP_USER_AGENT: BanQpay-PM";
            $merchant_link .= '&' .$data_stream;
            
            header("X-BanQpay-PM: VERIFIED", FALSE);
