...
<?
	...
	if ($merchant_data){
		echo "<div align=right class=tiny>You are now logged in as <b>$merchant_data->email</b> --- <a href=?a=merchant_account&$merchant_id>Manage Account</a>","</div>";
	}elseif ($_COOKIE['c_user']){
		echo "<div align=right class=tiny>Welcome back, <b>",$_COOKIE['c_merchant'],"</b>!</div>";
	}
	// Include action modules
	if (!$action){
		include('merchant/default_merchant_faq.php');
	}
