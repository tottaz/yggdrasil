...
class Admin extends Admin_Controller
{
	...
	public function group($group_id)
	{
		...
		$group_is_sadmin = (bool) ($this->config->item('admin_group', 'ion_auth') == $group->name);
		// Get the groups permission rules (no need if this is the admin group)
		$edit_permissions = ($group_is_sadmin) ? array() : $this->permission_m->get_group($group_id);
		...
		$this->template
			...
			->set('group_is_sadmin', $group_is_sadmin)
