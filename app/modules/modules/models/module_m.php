...
class Module_m extends My_Model
{
	...
	public function get($slug = '')
	{
		...
		if ($row)
		{
			...
			$name = ! isset($info['name'][CURRENT_LANGUAGE]) ? $info['name']['english'] : $info['name'][CURRENT_LANGUAGE];
			$description = ! isset($info['description'][CURRENT_LANGUAGE]) ? $info['description']['english'] : $info['description'][CURRENT_LANGUAGE];
	...
	public function get_all($params = array(), $return_disabled = false)
	{
		...
		{
			// Check if module can spawn itself
