...
<div class="page-header">
  <h1><?php echo __('analysis:searchalchemynews') ?><small> <?php echo __('analysis:searchalchemynewsdata') ?></small></h1>
</div>
...
<form class="form-horizontal" role="form" id="alchemynews" name="alchemynews" action="#">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button class="btn btn-primary" id="searchalchemynews"><?php echo __('analysis:searchalchemynews') ?></button>
    </div>
  </div>
...
$("#searchalchemynews").on("click", function() {
    var $form = $(this);
    $.ajax({
        type: 'get',
