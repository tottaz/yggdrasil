            ...
            "<div class='sp-container sp-hidden'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "<div class='sp-button-container sp-cf'>",
                        "<a class='btn btn-dark btn-sm sp-cancel' href='#'></a>",
                        "<button type='button' class='btn btn-success btn-sm m-b-0 m-r-0 sp-choose'></button>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    */
    ...
    function tinycolor (color, opts) {
        ...
        return {
            ...
            toRgbStringLight: function() {
                return  "rgba(" + mathRound(r) + ", " + mathRound(g) + ", " + mathRound(b) + ", 0.7)";
            },
