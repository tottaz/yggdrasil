			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td class="actions">
							<?php echo isset($theme->options) ? anchor('admin/themes/options/'.$theme->slug, lang('themes.options'), 'title="'.$theme->name.'" class="btn btn-success btn-sm options"') : ''; ?>
							<a href="<?php echo $theme->screenshot; ?>" rel="screenshots" title="<?php echo $theme->name; ?>" class="btn btn-danger btn-sm modal"><?php echo lang('buttons.preview'); ?></a>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
