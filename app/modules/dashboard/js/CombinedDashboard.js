...
window.DefaultTiles = [
    {
        name :"Dashboard",
        tiles: [
           { id: "socialstream", name: "socialstream" },
           { id: "flickr", name:"flickr" },
           { id: "rss", name: "rss" },
           { id: "weather", name: "weather" },
           { id: "calendar", name: "calendar" },
           { id: "myblog", name: "myblog" },
           { id: "email", name: "email" },
...
window.TileBuilders = {
    ...
    weather: function (uniqueId) {
        return {
            ...
            size: "tile-double",
            scriptSrc: ["app/modules/dashboard/tiles/weather/jquery.simpleWeather.js", "app/modules/dashboard/tiles/weather/weather.js"],
            cssSrc: ["app/modules/dashboard/tiles/weather/weather.css"],
    ...
    maps: function (uniqueId) {
        return {
            ...
            iconSrc: "app/modules/dashboard/img/googlemaps.png",
            appInNewWindow: true
        };
    },
            
    insights: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "insights",
            color: "bg-color-purple",
            label: "Insights",
            appTitle: "Insights",
            appUrl: "media/insights",
            iconSrc: "app/modules/dashboard/img/googlemaps.png",
            appInNewWindow: true
        };
    },            

    stats: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "Media Analysis",
            color: "bg-color-red",
            iconSrc: "app/modules/dashboard/img/nicechart.gif",
            label: "Media Analysis",
            appUrl: "media/stats"
        };
    },
            
    msearch: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "Media Search",
            color: "bg-color-blue",
            iconSrc: "app/modules/dashboard/img/search.png",
            label: "Media Search",
            appUrl: "media/search"
        };
    },
    ...
    video: function (uniqueId) {
        return {
            ...
            iconSrc: "app/modules/dashboard/img/youtube.png",
            slides: ['<iframe width="310" height="174" src="//www.youtube.com/embed/CGTNjPow3LM" frameborder="0" allowfullscreen></iframe>']
        };
    },
    ...
    facebook: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "facebook",
            iconSrc: "app/modules/dashboard/img/facebookalt3.png",
            label: "Facebook",
            color: "bg-color-blueDark",
            appUrl: "https://www.facebook.com/pages/greenpace/344728803064",
            appInNewWindow: true
        };
    },
            
    fbshares: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "FB Shares",
            color: "bg-color-blueDark",
            iconSrc: "app/modules/dashboard/img/facebookalt3.png",           
            size: "tile-double",            
            appUrl: "http://www.savethearctic.org",
            slidesFrom: ["app/modules/dashboard/tiles/fbgraph/fbgraph1.html",
                         "app/modules/dashboard/tiles/fbgraph/fbgraph2.html",
                         "app/modules/dashboard/tiles/fbgraph/fbgraph3.html"],
            cssSrc: ["app/modules/dashboard/tiles/fbgraph/fbgraph.css"]                     
        };
    },                                                
            
    twittercount: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "Twitter Count",
            iconSrc: "app/modules/dashboard/img/facebookalt3.png",
            label: "Twitter Likes",
            color: "bg-color-blueDark",
            appUrl: "http://urls.api.twitter.com/1/urls/count.json?url=http://www.savethearctic.org",
            appInNewWindow: true
        };
    },                        
    ...
    calendar: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "calendar",
            iconSrc: "app/modules/dashboard/img/calendar.png",
            label: "Calendar",
            size: "tile-double",
    ...
    flickr: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "flickr",
            iconSrc: "app/modules/dashboard/img/flickralt1.png",
            label: "Flickr",
            size: "tile-double tile-double-vertical",
            color: "bg-color-darken",
            appUrl: "app/modules/dashboard/tiles/flickr/app/FlickrApp.html",
            cssSrc: ["app/modules/dashboard/tiles/flickr/flickr.css"],
            scriptSrc: ["app/modules/dashboard/tiles/flickr/flickr.js?v=1"],
//            scriptSrc: ["app/modules/dashboard/tiles/flickr/flickr_interesting.js"],
//            cssSrc: ["app/modules/dashboard/tiles/flickr/flickr_interesting.css"],            
    ...
    email: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "email",
            iconSrc: "app/modules/dashboard/img/gmailalt.png",
            label: "Gmail",
            color: "bg-color-pink",
    ...
    wikipedia: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "wikipedia",
            tileImage: "app/modules/dashboard/img/wikipediaalt1.png",
            label: "Wikipedia",
            color: "bg-color-green",
            appIcon: "app/modules/dashboard/img/wikipediaalt1.png",
            appUrl: "http://en.wikipedia.org/wiki/Greenpeace"
        };
    },
            
    socialstream: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "socialstream",
            label: "Social Stream",
            size: "tile-double tile-quadro-vertical",
            color: "bg-color-green",
            slidesFrom: ["app/modules/dashboard/tiles/socialstream/index.html"],
            cssSrc: ["app/modules/dashboard/tiles/socialstream/css/socialstream.css"]    
        };
    },            
            
    socialtimeline: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "socialtimeline",
            label: "Social Timeline",
            color: "bg-color-blue",
            appUrl: "app/modules/dashboard/tiles/socialtimeline/twitter_timeline.html",
            iconSrc: 'app/modules/dashboard/img/googlereader.png'
        };
    },             

    socialwall: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "socialstream",
            label: "Social Wall",
            color: "bg-color-green",
            appUrl: "app/modules/dashboard/tiles/socialstream/wall.html",
            iconSrc: 'app/modules/dashboard/img/googlereader.png'
        };
    },            
    ...
    news: function (uniqueId) {
        return {
            ...
            scriptSrc: ["app/modules/dashboard/tiles/news/news.js?v=1"],
            cssSrc: ["app/modules/dashboard/tiles/news/news.css?v=1"],
            initFunc: "load_news",
    ...
    dynamicTile: function (uniqueId) {
        return {
            ...
            slidesFrom: ["app/modules/dashboard/tiles/DynamicTile/DynamicTile.aspx"]
    ...
    chart1: function (uniqueId) {
        return {
            ...
            size: "tile-triple tile-double-vertical",
            label: "Media Chart",
            appIcon: "app/modules/dashboard/img/hrdiv.png",            
            cssSrc: ["app/modules/dashboard/tiles/chart/style.css"],
            scriptSrc: ["app/modules/dashboard/tiles/chart/dx.xhartjs.js"],
            slidesFrom: ["app/modules/dashboard/tiles/chart/MultiplePanes.html"],
            initFunc: "load_chart"            
        }
    },    
    ...
    chart: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "chart",
            iconSrc: "app/modules/dashboard/img/charts1.jpg",
            label: "Charts",
            color: "bg-color-darken",
            appUrl: "app/modules/dashboard/tiles/chart/multipane.html",
            cssSrc: ["app/modules/dashboard/tiles/chart/style.css"],
//            scriptSrc: ["app/modules/dashboard/tiles/chart/dx.xhartjs.js"],          
            initFunc: "load_chart"
        };
    ...
    rss: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "rss",
            iconSrc: 'app/modules/dashboard/img/googlereader.png',
            label: "Latest Greenpeace News",                      
            color: "bg-color-blue",            
            appUrl: "app/modules/dashboard/tiles/rss/index.html",
        };
    },            
    ...
    myblog: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "news",
            label: "Torbjorn Zetterlund",
            color: "bg-color-green",
            size: "tile-double",
            appUrl: "http://torbjornzetterlund.com/feed/",
            scriptSrc: ["app/modules/dashboard/tiles/news/news.js?v=1"],
            cssSrc: ["app/modules/dashboard/tiles/news/news.css?v=1"],
            initFunc: "load_news",
            initParams: { url: "http://torbjornzetterlund.com/feed/" }
        };
    },
...
$(document).ready(function () {
    ...
    $("#navbar").tooltip({
        title: "Just hidding tills you want to use me",
        animate: true,
        placement: 'bottom',
        trigger: 'manual'
    });
