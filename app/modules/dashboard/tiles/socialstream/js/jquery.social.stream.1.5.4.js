			...
			this.defaults = {
				feeds: {
					facebook: {
						...
						icon: 'img/socialstream/facebook.png'
					},
					twitter: {
						id: '',
						intro: 'Tweeted',
						...
						url: 'app/modules/dashboard/tiles/socialstream/twitter.php',
						icon: 'img/socialstream/twitter.png'
					},
					google: {
						id: '',
						intro: 'Shared',
						...
						image_width: 75,
						shares: true,
						icon: 'img/socialstream/google.png'
					},
					youtube: {
						id: '',
						...
						thumb: 'default',
						icon: 'img/socialstream/youtube.png'
					},
					flickr: {
						id: '',
						intro: 'Uploaded',
						out: 'intro,thumb,title,text,share',
						lang: 'en-us',
						icon: 'img/socialstream/flickr.png'
					},
					delicious: {
						id: '',
						intro: 'Bookmarked',
						out: 'intro,thumb,title,text,user,share',
						icon: 'img/socialstream/delicious.png'
					},
					pinterest: {
						id: '',
						intro: 'Pinned',
						out: 'intro,thumb,text,user,share',
						icon: 'img/socialstream/pinterest.png'
					},
					rss: {
						id: '',
						intro: 'Posted',
					...
					lastfm: {
						...
						icon: 'img/socialstream/lastfm.png'
					},
					dribbble: {
						id: '',
						intro: 'Posted,Liked',
						out: 'intro,thumb,title,text,user,share',
						feed: 'shots,likes',
						icon: 'img/socialstream/dribbble.png'
					},
					vimeo: {
						id: '',
						...
						thumb: 'medium',
						stats: true,
						icon: 'img/socialstream/vimeo.png'
					},
					stumbleupon: {
						id: '',
						...
						icon: 'img/socialstream/stumbleupon.png'
					},
					deviantart: {
						id: '',
						intro: 'Deviation',
						out: 'intro,thumb,title,text,user,share',
						icon: 'img/socialstream/deviantart.png'
					},
					tumblr: {
						id: '',
						intro: 'Posted',
						...
						thumb: 100,
						video: 250,
						icon: 'img/socialstream/tumblr.png'
					},
					instagram: {
						id: '',
					    intro: 'Posted',
					    ...
					    comments: 3,
						likes: 8,
						icon: 'img/socialstream/instagram.png'
					}
				},
				remove: '',
				twitterId: '',
				...
				iconPath: 'app/modules/dashboard/tiles/socialstream/img/socialstream/',
				imagePath: 'app/modules/dashboard/tiles/socialstream/img/socialstream/',
				debug: false
			};
