...
thumb:"low_resolution",comments:3,likes:8,icon:"instagram.png"}},remove:"",twitterId:"",days:10,limit:50,max:"days",external:true,speed:600,height:550,wall:false,order:"date",filter:true,controls:true,rotate:{direction:"up",delay:8E3},cache:true,container:"dcsns",cstream:"stream",content:"dcsns-content",iconPath:"app/modules/dashboard/tiles/socialstream/",imagePath:"app/modules/dashboard/tiles/socialstream/",debug:false};this.o={},this.timer_on=0,this.id="dcsns-"+$(el).index(),this.timerId="",this.o=$.extend(true,this.defaults,options),opt=this.o,
