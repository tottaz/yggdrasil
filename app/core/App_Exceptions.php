 ...
 * with full backtraces and a view of the line with the error.  
 *
 * @package		CodeIgniter
...
class App_Exceptions extends CI_Exceptions {
	...
	public function __construct() {
		...
		set_exception_handler(array('App_Exceptions', 'exception_handler'));

		// Set the Error Handler
		set_error_handler(array('App_Exceptions', 'error_handler'));

		// Set the handler for shutdown to catch Parse errors
		register_shutdown_function(array('App_Exceptions', 'shutdown_handler'));
	}
