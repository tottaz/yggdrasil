...
('ldap_auth', 'LDAP Auth', 'Enable to allow for LDAP Authentication', 'select', '0', '0', '0=Disabled|1=Enabled', 1, 1, 'authentication', 0),
('ldap_connect', 'LDAP IP', 'LDAP URL or IP', 'text', '', '', '', 1, 1, 'authentication', 0),
('ldap_dc', 'LDAP DC', 'SET you LDAP DC parameters', 'text', 'ou=staff,dc=domain,dc=org', '', '', 1, 1, 'authentication', 0),
('ldap_port', 'LDAP Port', 'LDAP Port Number', 'text', '389', '', '', 1, 1, 'authentication', 0),
...
ALTER TABLE `{DBPREFIX}it_cdn_data`
...
ALTER TABLE `{DBPREFIX}it_cdn_data`
MODIFY `cdn_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;

-- split --

ALTER TABLE `{DBPREFIX}it_servicedesk_data`
MODIFY `servicedesk_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;

-- split --

ALTER TABLE `{DBPREFIX}eys`
